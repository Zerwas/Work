...
Equational unification is interesting for term rewriting systems \cite{TRS}. We will only consider boolean unification in more detail but there is also a lot of work on other equational theories like $AC$ \cite{TRS}. You can find more information on the complexity of boolean unification in \cite{cmplxBU}.
