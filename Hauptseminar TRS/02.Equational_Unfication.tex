...
Here we will only consider boolean unification in more detail but there are also other interesting equational theories like $AC$ the theory that axiomatizes associativity and commutativity \cite{TRS}.
