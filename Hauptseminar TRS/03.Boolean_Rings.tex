...
\[B:=\left\lbrace 
	...
	\begin{tabular*}{\textwidth}{cc}
		...
		\end{tikzpicture}
	\end{tabular*}
	This small example should just show that there are other models of $B$ with rather common interpretations of + and * apart from $\BTwo$. Note that if $|S|=1$ then $\mathcal{P}_S$ and $\BTwo$ are isomorphic.
	%correct word?
