...
\end{tikzpicture}\\
\end{center}
Gr\"oßte Vergleichsspannung bei $r=75\ mm,\\ \sigma_r(75\ mm)\approx-148,82
%\pgfmathparse{100*(2000*(\CA/0.7-\CB/(1.3*75*75)))}\pgfmathresult
\ N/mm^2\\
\sigma_\varphi(75\ mm)\approx-44,89
%\pgfmathparse{100*(2000*(\CA/0.7+\CB/(1.3*75*75)))}\pgfmathresult
\ N/mm^2\\
\sigma_v(75\ mm)\approx132,22\ N/mm^2
$.\\
\begin{center}
\begin{tikzpicture}
...
%\pgfmathparse{abs(\CA*300+\CB/300)}\pgfmathresult
\ mm$.
\section{ANSYS-L\"osung}
Tangential- und Radialspannung nach ANSYS-L\"osung.\\
\begin{center}
\includegraphics[width=0.9\linewidth]{/media/zerwas/0EF8-1256/NM-ANSYS/01_R_Phi}
\end{center}
\begin{center}
\includegraphics[width=0.9\linewidth]{/media/zerwas/0EF8-1256/NM-ANSYS/02_Vgl}
\end{center}
Maximale Vergleichspannung bei $r=75\ mm, \sigma_v(75\ mm)\approx 143,64\ N/mm^2$.\\
\begin{center}
\includegraphics[width=0.9\linewidth]{/media/zerwas/0EF8-1256/NM-ANSYS/03_versch_pic}
\end{center}
Die Verschiebung ist bei $r=300\ mm$ und $\varphi=\pi/4$ mit $0,097\ mm$ betragsm\"aßig maximal.
\begin{center}
\includegraphics[width=0.9\linewidth]{/media/zerwas/0EF8-1256/NM-ANSYS/04_versch}
\end{center}
\end{document}
