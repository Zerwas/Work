...
\begin{tikzpicture}[domain=0:9]
    ...
    \draw[color=red] plot[id=x] function{(\E*(\CA/0.7-\CB/(1.3*((x*25)+75)*((x*25)+75))))+3} 
            node[right] {$\sigma_r$};
    \draw[color=red] plot[id=x] function{(\E*(\CA/0.7+\CB/(1.3*((x*25)+75)*((x*25)+75))))+3} 
...
\begin{tikzpicture}[domain=0:9]
    ...
    \draw[->] (0,-1.2) -- (0,4.2) node[above] {$Spannung \left[ N/mm^2\right]$};
    \draw[color=red] plot[id=x] function{4000*sqrt((\CA/0.7-\CB/(1.3*((x*25)+75)*((x*25)+75)))*(\CA/0.7-\CB/(1.3*((x*25)+75)*((x*25)+75)))+(\CA/0.7+\CB/(1.3*((x*25)+75)*((x*25)+75)))*(\CA/0.7+\CB/(1.3*((x*25)+75)*((x*25)+75)))-(\CA/0.7+\CB/(1.3*((x*25)+75)*((x*25)+75)))*(\CA/0.7-\CB/(1.3*((x*25)+75)*((x*25)+75))))} 
                            node[right] {$\sigma_v$};
\end{tikzpicture}\\
\begin{tikzpicture}[domain=0:9]
    \draw[very thin,color=gray] (-0.1,-1.1) grid (9.1,3.9);
    ...
    \draw[color=red] plot[id=x] function{20*(\CA*((x*300/12)+75)-\CB/((x*25)+75))+1} 
        node[right] {$u_r$};
\end{tikzpicture}
\end{document}
